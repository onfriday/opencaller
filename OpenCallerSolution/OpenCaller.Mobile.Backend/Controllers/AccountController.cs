...
using OpenCaller.Mobile.Backend.Models;
using OpenCaller.Mobile.Backend.Providers;
using OpenCaller.Mobile.Backend.Results;
...
namespace OpenCaller.Mobile.Backend.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public AccountController(AuthUserManager pUserManager) //, ISecureDataFormat<AuthenticationTicket> accessTokenFormat)
        {
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                ClaimsIdentity oAuthIdentity = await IdentityUserExtensions.GenerateUserIdentityAsync(_UserManager, user, OAuthDefaults.AuthenticationType);
                ClaimsIdentity cookieIdentity = await IdentityUserExtensions.GenerateUserIdentityAsync(_UserManager, user, CookieAuthenticationDefaults.AuthenticationType);
